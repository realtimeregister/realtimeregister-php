...
class CertificateCollectionTest extends TestCase
{
    ...
    public function test_from_and_to_array(
        ...
        // Array access.
        self::assertInstanceOf(Certificate::class, $collection[0], 'Instance in collection does not implement DomainObjectInterface');
        ...
        foreach ($collection as $item) {
            self::assertInstanceOf(Certificate::class, $item, 'Instance in collection does not implement CertificateObjectInterface');
        }
        unset($collection[4]);
